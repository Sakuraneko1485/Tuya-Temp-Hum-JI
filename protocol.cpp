...
void all_data_update(void)
{
    ...
    mcu_dp_value_update(DPID_TEMP_CURRENT,Tuya_Temp); //VALUE型数据上报;
    mcu_dp_value_update(DPID_HUMIDITY_VALUE,Sht30_Hum); //VALUE型数据上报;
    mcu_dp_value_update(DPID_BATTERY_PERCENTAGE,Bat); //VALUE型数据上报;
